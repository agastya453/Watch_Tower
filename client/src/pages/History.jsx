...
export default function History() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <Link
        to="/dashboard"
        className="flex items-center text-sm font-medium text-gray-500 hover:text-apple-dark mb-8 gap-2"
      >
      ...
      <div className="relative border-l border-gray-200 ml-4 pb-12">
        {history.length === 0 ? (
          ...
          history.map((snapshot, index) => {
            const config =
              typeConfig[snapshot.change_type] ||
              typeConfig.none
            ...
            return (
              ...
              >
                <span
                  className={`absolute -left-[42px] flex h-8 w-8 items-center justify-center rounded-full ring-8 ring-[#f5f5f7] ${config.bg} ${config.color}`}
                >
                  <GitCommit size={16} />
                </span>
